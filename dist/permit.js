...
export class NoPermit extends Error {
    ...
    holder;
    permits;
    constructor(holder, permits) {
        super(`all ${permits} permit(s) for ${holder.scope} are held; the last is ` +
 ...
 */
export function permitFile(dir, key, slot) {
 ...
 */
export function acquirePermit(i) {
